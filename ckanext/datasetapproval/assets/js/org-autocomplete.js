this.ckan.module("org-autocomplete", function (jQuery) {
  return {
    ...
    options: {
      ...
      label: false,
      items: 10,
      source: "/api/3/action/org_autocomplete",
      tokensep: ",",
      interval: 300,
      dropdownClass: "",
      containerClass: "",
    ...
    getCompletions: function (string, fn) {
      ...
      var source = parts[0] + "?q=" + encodeURIComponent(string);
    ...
    formatResult: function (state, container, query, escapeMarkup) {
      ...
      return result.join(
        term && (escapeMarkup ? escapeMarkup(term) : term).bold(),
      );
    },
